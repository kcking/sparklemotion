...
@Serializable @SerialName("Boryli")
object Boryli : MovingHeadAdapter {
    override val id: String get() = "Boryli"
    ...
    override val colorWheelColors: List<Shenzarpy.WheelColor> = Shenzarpy.WheelColor.values.toList()
    ...
    class Buffer(override val dmxBuffer: Dmx.Buffer) : MovingHead.BaseBuffer(Boryli) {
